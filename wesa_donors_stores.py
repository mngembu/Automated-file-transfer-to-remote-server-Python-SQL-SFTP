...
sql_query_path = r"C:\Users\mngembu\pyproject\wesa\wesa_donors_stores.sql"
...
try:
    ...
    csv_file_path = os.path.join(WORK_SPACE, ("WESA_DONR_NEW_" + str(((date.today())-timedelta(days = 1)).strftime("%Y%m%d")) + ".csv"))
    ...
    # Clean the csv file, round GGCDonors column
    ...
    remoteFilePath = os.path.join("/GWAlberta3.0-NEW", ("WESA_DONR_NEW_" + str(((date.today())-timedelta(days = 1)).strftime("%Y%m%d")) + ".csv"))
    ...
    print("stores donor file transferred")
